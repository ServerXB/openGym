...
export default {
  ...
  '{0} to gain': '还需增重 {0}',
  '{0} to lose': '还需减重 {0}',
  'No entries yet — log your weight to start the curve.': '暂无记录——记录体重即可开始查看曲线。',
  'Best:': '最佳：',
  ...
  'Offline — changes saved on this device': '离线——更改已保存在本设备',
  '{0} changes waiting to sync': '{0} 项更改等待同步',
  'Syncing…': '正在同步…',
  'Synced at {0}': '已于 {0} 同步',
  'Sync conflict — your copies are safe': '同步冲突——两份副本均安全',
  'Sign in again to sync': '请重新登录以同步',
  'Your local changes are safe on this device.': '你的本地更改已安全保存在本设备。',
  'Could not sign out — sync or export the pending changes first.': '无法退出登录——请先同步或导出待处理的更改。',
  'Could not sign out — you are still signed in.': '无法退出登录——你仍处于登录状态。',
  'Local save failed — stop editing and export a backup': '本地保存失败——请停止编辑并导出备份',
  'Sync paused — your changes are saved on this device': '同步已暂停——更改已保存在本设备',
  'Saved on this device': '已保存在本设备',
  'Sync now': '立即同步',
  'Hide details': '隐藏详情',
  'Review': '查看',
  'Finish the workout before resolving this conflict.': '请先完成训练，再解决此冲突。',
  '{0} conflicting fields. Non-conflicting changes are already combined.': '有 {0} 个字段冲突。无冲突的更改已合并。',
  '+{0} more': '另有 {0} 项',
  'Export this device': '导出本设备副本',
  'Export server copy': '导出服务器副本',
  'Export other device copy': '导出其他设备副本',
  'Use this device': '使用本设备副本',
  'Use server': '使用服务器副本',
  'Use other device copy': '使用其他设备副本',
  ...
  'General': '通用',
  'Workout start': '开始训练',
  'Ask for body weight': '询问体重',
  'Show the quick check-in before every new workout. Manual logging stays available.': '每次开始新训练前显示快速记录。仍可手动记录体重。',
