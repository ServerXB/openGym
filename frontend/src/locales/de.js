...
export default {
  ...
  'Offline — changes saved on this device': 'Offline — Änderungen auf diesem Gerät gespeichert',
  '{0} changes waiting to sync': '{0} Änderungen warten auf die Synchronisierung',
  'Syncing…': 'Wird synchronisiert…',
  'Synced at {0}': 'Um {0} synchronisiert',
  'Sync conflict — your copies are safe': 'Synchronisierungskonflikt — deine Kopien sind sicher',
  'Sign in again to sync': 'Melde dich erneut an, um zu synchronisieren',
  'Your local changes are safe on this device.': 'Deine lokalen Änderungen sind auf diesem Gerät sicher.',
  'Could not sign out — sync or export the pending changes first.': 'Abmelden nicht möglich — synchronisiere oder exportiere zuerst die ausstehenden Änderungen.',
  'Could not sign out — you are still signed in.': 'Abmelden nicht möglich — du bist weiterhin angemeldet.',
  'Local save failed — stop editing and export a backup': 'Lokales Speichern fehlgeschlagen — bearbeite nichts weiter und exportiere eine Sicherung',
  'Sync paused — your changes are saved on this device': 'Synchronisierung pausiert — deine Änderungen sind auf diesem Gerät gespeichert',
  'Saved on this device': 'Auf diesem Gerät gespeichert',
  'Sync now': 'Jetzt synchronisieren',
  'Hide details': 'Details ausblenden',
  'Review': 'Prüfen',
  'Finish the workout before resolving this conflict.': 'Beende das Training, bevor du diesen Konflikt löst.',
  '{0} conflicting fields. Non-conflicting changes are already combined.': '{0} widersprüchliche Felder. Änderungen ohne Konflikt wurden bereits zusammengeführt.',
  '+{0} more': '+{0} weitere',
  'Export this device': 'Dieses Gerät exportieren',
  'Export server copy': 'Serverkopie exportieren',
  'Export other device copy': 'Kopie des anderen Geräts exportieren',
  'Use this device': 'Dieses Gerät verwenden',
  'Use server': 'Server verwenden',
  'Use other device copy': 'Kopie des anderen Geräts verwenden',
