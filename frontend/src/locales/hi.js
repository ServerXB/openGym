...
export default {
  ...
  'Sign out': 'साइन आउट',
  'Synchronization status': 'सिंक की स्थिति',
  'Offline — changes saved on this device': 'ऑफ़लाइन — बदलाव इस डिवाइस पर सेव हैं',
  '{0} changes waiting to sync': '{0} बदलाव सिंक होने बाकी हैं',
  'Syncing…': 'सिंक हो रहा है…',
  'Synced at {0}': '{0} पर सिंक किया गया',
  'Sync conflict — your copies are safe': 'सिंक में टकराव — आपकी प्रतियाँ सुरक्षित हैं',
  'Sign in again to sync': 'सिंक करने के लिए फिर से साइन इन करें',
  'Your local changes are safe on this device.': 'आपके स्थानीय बदलाव इस डिवाइस पर सुरक्षित हैं।',
  'Could not sign out — sync or export the pending changes first.': 'साइन आउट नहीं हो सका — पहले बाकी बदलावों को सिंक या एक्सपोर्ट करें।',
  'Could not sign out — you are still signed in.': 'साइन आउट नहीं हो सका — आप अभी भी साइन इन हैं।',
  'Local save failed — stop editing and export a backup': 'डिवाइस पर सेव नहीं हो सका — बदलाव करना रोकें और बैकअप एक्सपोर्ट करें',
  'Sync paused — your changes are saved on this device': 'सिंक रुका हुआ है — आपके बदलाव इस डिवाइस पर सेव हैं',
  'Saved on this device': 'इस डिवाइस पर सेव है',
  'Sync now': 'अभी सिंक करें',
  'Hide details': 'विवरण छिपाएँ',
  'Review': 'समीक्षा करें',
  'Finish the workout before resolving this conflict.': 'इस टकराव को हल करने से पहले वर्कआउट पूरा करें।',
  '{0} conflicting fields. Non-conflicting changes are already combined.': '{0} फ़ील्ड में टकराव है। बिना टकराव वाले बदलाव पहले ही जोड़ दिए गए हैं।',
  '+{0} more': '+{0} और',
  'Export this device': 'इस डिवाइस की प्रति एक्सपोर्ट करें',
  'Export server copy': 'सर्वर की प्रति एक्सपोर्ट करें',
  'Export other device copy': 'दूसरे डिवाइस की प्रति एक्सपोर्ट करें',
  'Use this device': 'इस डिवाइस की प्रति इस्तेमाल करें',
  'Use server': 'सर्वर की प्रति इस्तेमाल करें',
  'Use other device copy': 'दूसरे डिवाइस की प्रति इस्तेमाल करें',
  ...
  'General': 'सामान्य',
  'Workout start': 'वर्कआउट शुरू करना',
  'Ask for body weight': 'शरीर का वज़न पूछें',
  'Show the quick check-in before every new workout. Manual logging stays available.': 'हर नए वर्कआउट से पहले त्वरित चेक-इन दिखाएँ। मैन्युअल रूप से वज़न दर्ज करना उपलब्ध रहेगा।',
