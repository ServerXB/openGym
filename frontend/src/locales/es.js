...
export default {
  ...
  'No entries yet — log your weight to start the curve.': 'Aún no hay registros — apunta tu peso para iniciar la curva.',
  'Best:': 'Mejor:',
  ...
  'Offline — changes saved on this device': 'Sin conexión — cambios guardados en este dispositivo',
  '{0} changes waiting to sync': '{0} cambios pendientes de sincronización',
  'Syncing…': 'Sincronizando…',
  'Synced at {0}': 'Sincronizado a las {0}',
  'Sync conflict — your copies are safe': 'Conflicto de sincronización — tus copias están seguras',
  'Sign in again to sync': 'Vuelve a iniciar sesión para sincronizar',
  'Your local changes are safe on this device.': 'Tus cambios locales están seguros en este dispositivo.',
  'Could not sign out — sync or export the pending changes first.': 'No se pudo cerrar sesión — sincroniza o exporta primero los cambios pendientes.',
  'Could not sign out — you are still signed in.': 'No se pudo cerrar sesión — sigues conectado.',
  'Local save failed — stop editing and export a backup': 'Error al guardar localmente — deja de editar y exporta una copia de seguridad',
  'Sync paused — your changes are saved on this device': 'Sincronización en pausa — tus cambios están guardados en este dispositivo',
  'Saved on this device': 'Guardado en este dispositivo',
  'Sync now': 'Sincronizar ahora',
  'Hide details': 'Ocultar detalles',
  'Review': 'Revisar',
  'Finish the workout before resolving this conflict.': 'Termina el entrenamiento antes de resolver este conflicto.',
  '{0} conflicting fields. Non-conflicting changes are already combined.': '{0} campos en conflicto. Los cambios sin conflicto ya están combinados.',
  '+{0} more': '+{0} más',
  'Export this device': 'Exportar este dispositivo',
  'Export server copy': 'Exportar copia del servidor',
  'Export other device copy': 'Exportar copia del otro dispositivo',
  'Use this device': 'Usar este dispositivo',
  'Use server': 'Usar el servidor',
  'Use other device copy': 'Usar copia del otro dispositivo',
  ...
  'General': 'General',
  'Workout start': 'Inicio del entrenamiento',
  'Ask for body weight': 'Pedir el peso corporal',
  'Show the quick check-in before every new workout. Manual logging stays available.': 'Muestra el registro rápido antes de cada nuevo entrenamiento. El registro manual sigue disponible.',
