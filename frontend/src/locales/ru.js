...
export default {
  ...
  'No entries yet — log your weight to start the curve.': 'Записей пока нет — внесите вес, чтобы начать график.',
  'Best:': 'Рекорд:',
  ...
  'Offline — changes saved on this device': 'Нет сети — изменения сохранены на этом устройстве',
  '{0} changes waiting to sync': 'Изменений в очереди на синхронизацию: {0}',
  'Syncing…': 'Синхронизация…',
  'Synced at {0}': 'Синхронизировано в {0}',
  'Sync conflict — your copies are safe': 'Конфликт синхронизации — обе копии в безопасности',
  'Sign in again to sync': 'Войдите снова, чтобы синхронизировать данные',
  'Your local changes are safe on this device.': 'Локальные изменения сохранены на этом устройстве.',
  'Could not sign out — sync or export the pending changes first.': 'Не удалось выйти — сначала синхронизируйте или экспортируйте ожидающие изменения.',
  'Could not sign out — you are still signed in.': 'Не удалось выйти — вы по-прежнему авторизованы.',
  'Local save failed — stop editing and export a backup': 'Не удалось сохранить локально — прекратите редактирование и экспортируйте резервную копию',
  'Sync paused — your changes are saved on this device': 'Синхронизация приостановлена — изменения сохранены на этом устройстве',
  'Saved on this device': 'Сохранено на этом устройстве',
  'Sync now': 'Синхронизировать сейчас',
  'Hide details': 'Скрыть подробности',
  'Review': 'Проверить',
  'Finish the workout before resolving this conflict.': 'Завершите тренировку, прежде чем разрешать этот конфликт.',
  '{0} conflicting fields. Non-conflicting changes are already combined.': 'Конфликтующих полей: {0}. Остальные изменения уже объединены.',
  '+{0} more': 'Ещё {0}',
  'Export this device': 'Экспортировать копию с этого устройства',
  'Export server copy': 'Экспортировать копию с сервера',
  'Export other device copy': 'Экспортировать копию с другого устройства',
  'Use this device': 'Использовать копию с этого устройства',
  'Use server': 'Использовать копию с сервера',
  'Use other device copy': 'Использовать копию с другого устройства',
  ...
  'General': 'Основное',
  'Workout start': 'Начало тренировки',
  'Ask for body weight': 'Запрашивать вес тела',
  'Show the quick check-in before every new workout. Manual logging stays available.': 'Показывать быструю запись веса перед каждой новой тренировкой. Ручной ввод останется доступен.',
