...
export default {
  ...
  'No entries yet — log your weight to start the curve.': 'Henüz kayıt yok — grafiği başlatmak için kilonu gir.',
  'Best:': 'Rekor:',
  ...
  'Sign out': 'Çıkış yap',
  'Synchronization status': 'Eşitleme durumu',
  'Offline — changes saved on this device': 'Çevrimdışı — değişiklikler bu cihaza kaydedildi',
  '{0} changes waiting to sync': '{0} değişiklik eşitlenmeyi bekliyor',
  'Syncing…': 'Eşitleniyor…',
  'Synced at {0}': '{0} saatinde eşitlendi',
  'Sync conflict — your copies are safe': 'Eşitleme çakışması — kopyaların güvende',
  'Sign in again to sync': 'Eşitlemek için yeniden giriş yap',
  'Your local changes are safe on this device.': 'Yerel değişikliklerin bu cihazda güvende.',
  'Could not sign out — sync or export the pending changes first.': 'Çıkış yapılamadı — önce bekleyen değişiklikleri eşitle veya dışa aktar.',
  'Could not sign out — you are still signed in.': 'Çıkış yapılamadı — oturumun hâlâ açık.',
  'Local save failed — stop editing and export a backup': 'Yerel kayıt başarısız — düzenlemeyi bırak ve bir yedek dışa aktar',
  'Sync paused — your changes are saved on this device': 'Eşitleme duraklatıldı — değişikliklerin bu cihaza kaydedildi',
  'Saved on this device': 'Bu cihaza kaydedildi',
  'Sync now': 'Şimdi eşitle',
  'Hide details': 'Ayrıntıları gizle',
  'Review': 'İncele',
  'Finish the workout before resolving this conflict.': 'Bu çakışmayı çözmeden önce antrenmanı bitir.',
  '{0} conflicting fields. Non-conflicting changes are already combined.': '{0} alanda çakışma var. Çakışmayan değişiklikler zaten birleştirildi.',
  '+{0} more': '+{0} daha',
  'Export this device': 'Bu cihazdaki kopyayı dışa aktar',
  'Export server copy': 'Sunucu kopyasını dışa aktar',
  'Export other device copy': 'Diğer cihazdaki kopyayı dışa aktar',
  'Use this device': 'Bu cihazdaki kopyayı kullan',
  'Use server': 'Sunucu kopyasını kullan',
  'Use other device copy': 'Diğer cihazdaki kopyayı kullan',
  ...
  'General': 'Genel',
  'Workout start': 'Antrenman başlangıcı',
  'Ask for body weight': 'Vücut ağırlığını sor',
  'Show the quick check-in before every new workout. Manual logging stays available.': 'Her yeni antrenmandan önce hızlı kontrolü göster. Elle kayıt yapmaya devam edebilirsin.',
