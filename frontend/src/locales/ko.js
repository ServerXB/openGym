...
export default {
  ...
  'Offline — changes saved on this device': '오프라인 — 변경 사항이 이 기기에 저장됨',
  '{0} changes waiting to sync': '동기화 대기 중인 변경 사항 {0}개',
  'Syncing…': '동기화 중…',
  'Synced at {0}': '{0}에 동기화됨',
  'Sync conflict — your copies are safe': '동기화 충돌 — 두 사본 모두 안전합니다',
  'Sign in again to sync': '동기화하려면 다시 로그인하세요',
  'Your local changes are safe on this device.': '로컬 변경 사항은 이 기기에 안전하게 보관되어 있습니다.',
  'Could not sign out — sync or export the pending changes first.': '로그아웃할 수 없습니다 — 먼저 대기 중인 변경 사항을 동기화하거나 내보내세요.',
  'Could not sign out — you are still signed in.': '로그아웃할 수 없습니다 — 아직 로그인되어 있습니다.',
  'Local save failed — stop editing and export a backup': '로컬 저장 실패 — 편집을 중단하고 백업을 내보내세요',
  'Sync paused — your changes are saved on this device': '동기화 일시 중지 — 변경 사항이 이 기기에 저장되어 있습니다',
  'Saved on this device': '이 기기에 저장됨',
  'Sync now': '지금 동기화',
  'Hide details': '세부 정보 숨기기',
  'Review': '검토',
  'Finish the workout before resolving this conflict.': '이 충돌을 해결하기 전에 운동을 완료하세요.',
  '{0} conflicting fields. Non-conflicting changes are already combined.': '충돌하는 필드 {0}개. 충돌하지 않는 변경 사항은 이미 병합되었습니다.',
  '+{0} more': '+{0}개 더',
  'Export this device': '이 기기 사본 내보내기',
  'Export server copy': '서버 사본 내보내기',
  'Export other device copy': '다른 기기 사본 내보내기',
  'Use this device': '이 기기 사본 사용',
  'Use server': '서버 사본 사용',
  'Use other device copy': '다른 기기 사본 사용',
  ...
  'General': '일반',
  'Workout start': '운동 시작',
  'Ask for body weight': '체중 묻기',
  'Show the quick check-in before every new workout. Manual logging stays available.': '새 운동을 시작할 때마다 빠른 체크인을 표시합니다. 수동 기록은 계속 사용할 수 있습니다.',
